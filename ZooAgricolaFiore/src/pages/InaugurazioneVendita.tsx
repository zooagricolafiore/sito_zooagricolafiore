          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-8">
              ...
              <p className="text-muted-foreground text-lg">
                L'apertura del nostro spazio di vendita aziendale
              </p>
            </div>
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-foreground/80 text-lg leading-relaxed">
                Il 29 ottobre 2011 abbiamo inaugurato il nostro punto vendita aziendale, segnando ufficialmente l'inizio della vendita al dettaglio. 
                Un giorno storico per ZooAgricola Fiore e per Daniele Magnaterra che, appena ventunenne, ha assunto con entusiasmo la responsabilità 
                di guidare l'attività commerciale della quarta generazione di famiglia, portando avanti con orgoglio la tradizione di famiglia e 
...
export default InaugurazioneVendita;