          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-8">
              ...
              <p className="text-muted-foreground text-lg">
                Eccellenze norcine e grandi vini italiani
              </p>
            </div>
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-foreground/80 text-lg leading-relaxed">
                Presenti al Vinitaly di Verona, insieme alla cantina Castello delle Regine, abbiamo offerto ai visitatori internazionali 
                l'occasione di degustare salumi e carni selezionate della nostra produzione. Un incontro esclusivo tra le eccellenze norcine 
                e i grandi vini italiani.
              </p>
            </div>
          </div>
        </div>
