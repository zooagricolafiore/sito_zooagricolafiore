          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-8">
              ...
              <p className="text-muted-foreground text-lg">
                Energia e sapore per gli atleti
              </p>
            </div>
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-foreground/80 text-lg leading-relaxed">
                Abbiamo accompagnato gli atleti della Spartan Race a Orte con la nostra porchetta artigianale e i salumi genuini. 
                Energia, qualità e sapore autentico per una sfida sportiva ad alto livello, insieme a un team sempre pronto a tifare 
...
export default SpartanRaceOrte;
