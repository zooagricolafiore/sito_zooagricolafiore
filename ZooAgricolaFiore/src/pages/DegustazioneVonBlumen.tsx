          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-8">
              <h2 className="text-4xl font-bold text-foreground mb-4">
                Degustazione stalla San Sebastiano cantina Von Blumen
              </h2>
              <p className="text-muted-foreground text-lg">
                Un evento esclusivo di degustazione e abbinamento
              </p>
            </div>
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-foreground/80 text-lg leading-relaxed">
                Nella suggestiva cornice della Contrada San Sebastiano, abbiamo abbinato i nostri migliori salumi artigianali ai prestigiosi vini 
                altoatesini della Cantina Von Blumen. Una serata esclusiva dedicata all'incontro tra sapori autentici, aromi intensi e convivialità.
              </p>
            </div>
          </div>
        </div>
...
export default DegustazioneVonBlumen;