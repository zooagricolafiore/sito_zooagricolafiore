...
const CentenarioAeronautica = () => {
  ...
  const allProjects = [
    ...
    {
      title: "Ricette all'Italiana",
      image: rete4,
      link: "/ricette-italiana-mengacci",
    },
    {
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-8">
              <h2 className="text-4xl font-bold text-foreground mb-4">
                Stand Gastronomico Centenario Aeronautica Militare
              </h2>
              <p className="text-muted-foreground text-lg">
                Celebrando 100 anni di eccellenza
              </p>
            </div>
            ...
            <div className="rounded-2xl overflow-hidden mb-8">
              <img
                src={areonautica}
                alt="Centenario Aeronautica Militare"
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-foreground/80 text-lg leading-relaxed">
                In occasione del centenario dell'Aeronautica Militare, ZooAgricola Fiore ha partecipato con entusiasmo all'evento celebrativo, 
                allestendo uno stand gastronomico ricco delle nostre specialità norcine. Un momento di festa e di orgoglio, in cui abbiamo avuto 
                l'onore di condividere la qualità dei nostri prodotti con ospiti illustri e appassionati, celebrando insieme questa importante ricorrenza.
              </p>
            </div>
          </div>
        </div>
...
export default CentenarioAeronautica;
